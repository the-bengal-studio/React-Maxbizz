        ...
        <div class="page-header flex-middle page-header-service">
          <div class="container">
            <div class="inner flex-middle">
              <h1 class="page-title">Support Function</h1>
              <ul id="breadcrumbs" class="breadcrumbs none-style">
                <li>
                  <Link to="/">Home</Link>
                </li>
                <li class="active">Support Function</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-xl-9 col-lg-8 mb-5 mb-lg-0">
              ...
              <div class="row align-items-center">
                <div class="col-md-6 mb-6 mb-md-0 pr-md-0">
                ...
                <div class="col-md-6 pl-md-4">
                  ...
                  <p>
                    ...
                    the{" "}
                    <span class="text-color-primary">“customer wheel.” </span>{" "}
